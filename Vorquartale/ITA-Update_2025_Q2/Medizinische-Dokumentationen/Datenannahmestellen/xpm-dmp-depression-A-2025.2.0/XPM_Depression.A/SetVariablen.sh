...
XPM_CLASS_PATH=${XPM_INSTALLATION_DIR}/Bin/jasperreports-fonts-6.12.2.jar:${XPM_INSTALLATION_DIR}/Bin/xpm-core-4.2.28.jar:${XPM_INSTALLATION_DIR}/Bin/xpm-dmp-depression-2025.2.0.jar
