...
XPM_CLASS_PATH=${XPM_INSTALLATION_DIR}/Bin/jasperreports-fonts-6.12.2.jar:${XPM_INSTALLATION_DIR}/Bin/xpm-core-4.2.37.jar:${XPM_INSTALLATION_DIR}/Bin/xpm-dmp-dm2-2025.4.0.jar
