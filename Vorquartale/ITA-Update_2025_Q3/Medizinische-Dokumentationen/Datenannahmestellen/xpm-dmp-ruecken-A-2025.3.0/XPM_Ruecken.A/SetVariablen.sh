...
XPM_CLASS_PATH=${XPM_INSTALLATION_DIR}/Bin/jasperreports-fonts-6.12.2.jar:${XPM_INSTALLATION_DIR}/Bin/xpm-core-4.2.33.jar:${XPM_INSTALLATION_DIR}/Bin/xpm-dmp-ruecken-2025.3.0.jar
